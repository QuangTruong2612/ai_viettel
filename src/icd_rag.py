...
class ICDRetriever:
    ...
    def _init_icd_vn_to_codes(self) -> None:
        ...
        self._icd_vn_to_codes = {
            ...
            # === MỚI 2026-07-24 (R39) — Enzyme-deficiency & blood diseases ===
            # Bug history: "Thiếu men G6PD" → match M08.1/Q55.0 sai.
            # Đúng ICD: D55.0 (Anaemia do enzyme defect — G6PD deficiency).
            ...
            "tăng bilirubin": ["E80.7", "R17"],
            "tăng bilirubin gián tiếp": ["E80.7", "R17"],
            "tăng bilirubin trực tiếp": ["E80.5", "R17"],
            # === MỚI 2026-07-24 (R39) — Drug-class blacklist via candidates ===
            # Bệnh cảm/sốt thông thường
            "cảm cúm": ["J11", "J11.1"],
            "cảm lạnh": ["J00"],
            "viêm họng": ["J02", "J02.9"],
            "viêm amidan": ["J03", "J03.9"],
            # Bệnh lý phổ biến VN
            "viêm xoang": ["J32", "J32.9"],
            "viêm mũi": ["J30", "J30.9"],
            "viêm phế quản": ["J20", "J20.9"],
            "hen": ["J45", "J45.9"],
            "hen suyễn": ["J45", "J45.9"],
            "COPD": ["J44", "J44.9"],
            "bệnh phổi tắc nghẽn mạn tính": ["J44", "J44.9"],
            "hen phế quản": ["J45", "J45.9"],
            # Bệnh thận - tiết niệu
            "viêm bàng quang": ["N30", "N30.9"],
            "viêm thận": ["N05", "N05.9"],
            "viêm bể thận": ["N10", "N11"],
            "sỏi tiết niệu": ["N20", "N20.0"],
            "nhiễm trùng tiết niệu": ["N39.0"],
            # Bệnh da liễu
            "viêm da": ["L30", "L30.9"],
            "viêm da cơ địa": ["L20", "L20.9"],
            "viêm da tiếp xúc": ["L23", "L23.9"],
            "viêm da dị ứng": ["L23", "L23.9"],
            "mày đay": ["L50", "L50.9"],
            "mày đay vô căn": ["L50", "L50.9"],
            "eczema": ["L20", "L20.9"],
            "vảy nến": ["L40", "L40.9"],
            "nấm da": ["B35", "B35.9"],
            "ghẻ": ["B86"],
            ...
            "herpes": ["B00", "B00.9"],
            # Bệnh tai mũi họng
            "viêm tai giữa": ["H66", "H66.9"],
            "viêm tai ngoài": ["H60", "H60.9"],
            "viêm tai": ["H66", "H66.9"],
            # Bệnh mắt
            "đau mắt đỏ": ["H10", "H10.9"],
            "viêm kết mạc": ["H10", "H10.9"],
            "đục thủy tinh thể": ["H25", "H25.9"],
            "glaucoma": ["H40", "H40.9"],
            "cườm nước": ["H40", "H40.9"],
            "cườm khô": ["H25", "H25.9"],
            # Bệnh tiêu hóa
            "viêm dạ dày": ["K29", "K29.7"],
            "viêm loét dạ dày": ["K25", "K25.9"],
            "loét dạ dày": ["K25", "K25.9"],
            "loét tá tràng": ["K26", "K26.9"],
            "trào ngược dạ dày": ["K21", "K21.9"],
            "GERD": ["K21", "K21.9"],
            "viêm đại tràng": ["K52", "K52.9"],
            "hội chứng ruột kích thích": ["K58", "K58.9"],
            "IBS": ["K58", "K58.9"],
            "táo bón": ["K59.0"],
            "tiêu chảy": ["K52", "K52.9"],
            "kiết lỵ": ["A03", "A03.9"],
            ...
            "parkinson": ["G20", "G20.9"],
            "alzheimer": ["G30", "G30.9"],
            "sa sút trí tuệ": ["F03", "F03.9"],
            "trầm cảm": ["F32", "F32.9"],
            "lo âu": ["F41", "F41.9"],
            "rối loạn lo âu": ["F41", "F41.9"],
            "mất ngủ": ["G47.0"],
            "rối loạn giấc ngủ": ["G47", "G47.9"],
            "viêm dây thần kinh": ["G61", "G61.9"],
            "viêm đa dây thần kinh": ["G61", "G61.9"],
            "đau thần kinh tọa": ["M54.3", "M54.4"],
            # Bệnh cơ xương khớp
            "thoái hóa khớp": ["M15", "M19", "M19.9"],
            "thoái hóa cột sống": ["M47", "M47.9"],
            "thoát vị đĩa đệm": ["M51", "M51.9"],
            "viêm khớp": ["M13", "M13.9"],
            "viêm đa khớp": ["M13", "M13.9"],
            "nhồi máu cơ tim cấp": ["I21", "I21.9"],
            "nhồi máu cơ tim cấp st chênh lên": ["I21", "I21.0", "I21.1", "I21.2", "I21.3"],
            "nhồi máu cơ tim có st chênh lên": ["I21", "I21.0", "I21.1", "I21.2", "I21.3"],
            "nmct st chênh lên": ["I21", "I21.0", "I21.1", "I21.2", "I21.3"],
            "stemi": ["I21", "I21.0", "I21.1", "I21.2", "I21.3"],
            "nhồi máu cơ tim không st chênh": ["I21.4"],
            "nstemi": ["I21.4"],
            "loãng xương": ["M80", "M80.9"],
            "gãy xương": ["S72", "S72.9"],
            "gãy cổ xương đùi": ["S72", "S72.0"],
            "gãy xương đùi": ["S72", "S72.9"],
            "gãy cẳng tay": ["S52", "S52.9"],
            "gãy xương cẳng tay": ["S52", "S52.9"],
            "trật khớp": ["S43", "S43.0"],
            "bong gân": ["S93", "S93.4"],
            ...
            # === R39 (2026-07-24) - Kawasaki, viêm tim, phình mạch (Cardiovascular often missed) ===
            "kawasaki": ["M30.3"],
            "bệnh kawasaki": ["M30.3"],
            "viêm kawasaki": ["M30.3"],
            "hội chứng da niêm mạc hạch bạch huyết": ["M30.3"],  # Kawasaki synonyms
            "mcls": ["M30.3"],
            "viêm tim": ["I40.9", "I51.4"],
            "viêm cơ tim": ["I40.9", "I51.4"],
            "viêm màng ngoài tim": ["I30.9"],
            "viêm nội tâm mạc": ["I33.0"],
            "viêm màng trong tim": ["I33.0"],
            "viêm cơ tim phì đại": ["I42.1"],
            "viêm cơ tim giãn": ["I42.0"],
            "bệnh cơ tim": ["I42.9"],
            "phình giãn động mạch vành": ["I25.4"],
            "phình động mạch vành": ["I25.4"],
            "giãn động mạch vành": ["I25.4"],
            "phình động mạch": ["I72.9"],
            "phình mạch": ["I72.9"],
            ...
            "hẹp động mạch": ["I77.1"],
            "huyết khối": ["I82"],
            "huyết khối tĩnh mạch": ["I82.9"],
            "huyết khối động mạch": ["I74.9"],
            "thuyên tắc phổi": ["I26.9"],
            "thuyên tắc mạch phổi": ["I26.9"],
            "tắc mạch phổi": ["I26.9"],
            "suy mạch": ["I99"],
            "viêm nội tâm mạc nhiễm khuẩn": ["I33.0"],
            "viêm nội tâm mạc cấp": ["I33.0"],
            "viêm nội tâm mạc bán cấp": ["I33.0"],
            # === End R39 cardiovascular additions ===
