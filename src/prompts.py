...
6. **Bệnh Kawasaki / viêm tim** (đề cao cho trẻ em): bệnh Kawasaki, viêm tim, viêm cơ tim, viêm màng ngoài tim → CHẨN_ĐOÁN.
7. **Phình/hẹp mạch máu**: phình giãn động mạch vành, phình động mạch chủ, hẹp động mạch cảnh → CHẨN_ĐOÁN.
...
# R39 (2026-07-24) — QUY TẮC BẮT BUỘC ĐẦU TIÊN: GIỮ NGUYÊN TEXT
- entity_text PHẢI là substring chính xác `input_text[start:end]` — KHÔNG thêm space, KHÔNG đổi case, KHÔNG thêm/bớt ký tự.
- Nếu bạn nghi ngờ entity_text đã bị LLM Stage 1 hallucinate, vẫn giữ nguyên text và chỉ điều chỉnh `type` + `assertions`.
...
# 🎯 R39 (2026-07-24) — BẢNG PHÂN LOẠI TYPE NHANH (copy-paste khi cần):

| Nhóm entity | Type | Ví dụ |
|---|---|---|
| Bệnh viêm | CHẨN_ĐOÁN | viêm phổi, viêm gan, viêm dạ dày, viêm khớp, viêm màng não, viêm tiết niệu, viêm tai giữa, viêm amidan, viêm kết mạc |
| Bệnh Kawasaki (trẻ em) | CHẨN_ĐOÁN | bệnh Kawasaki, viêm mạch máu Kawasaki, hội chứng da niêm mạc hạch bạch huyết (MCLS) |
| Bệnh tim mạch | CHẨN_ĐOÁN | viêm tim, viêm cơ tim, viêm màng ngoài tim, viêm nội tâm mạc, viêm mạch, viêm động mạch |
| Phình/hẹp mạch | CHẨN_ĐOÁN | phình giãn động mạch vành, phình động mạch chủ, hẹp/hở van tim, tắc động mạch, huyết khối |
| Tắc mạch/huyết khối | CHẨN_ĐOÁN | huyết khối tĩnh mạch, thuyên tắc phổi, tắc mạch não, nhồi máu cơ tim, nhồi máu não |
| Bệnh thiếu máu/enzym | CHẨN_ĐOÁN | thiếu máu tan huyết, thiếu men G6PD, tan máu tự miễn, hemophilia |
| Sốt, vàng da, sưng | depends | sốt cao (TRIỆU_CHỨNG), vàng da (CHẨN_ĐOÁN nếu "vàng da tắc mật" hoặc "vàng da sơ sinh"), phù chân (TRIỆU_CHỨNG) |
| Nhiễm trùng | CHẨN_ĐOÁN | nhiễm khuẩn huyết, nhiễm trùng huyết, viêm phổi (sẽ là CHẨN_ĐOÁN), nhiễm khuẩn tiết niệu |
| Bệnh nhi | CHẨN_ĐOÁN | tay chân miệng, sởi, thủy đậu, ho gà, bạch hầu, rubella, sốt xuất huyết |
| Bệnh da liễu | CHẨN_ĐOÁN | viêm da cơ địa, eczema, vảy nến, mày đay, nấm da, ghẻ, zona |
| Dị ứng | CHẨN_ĐOÁN/TRIỆU_CHỨNG | dị ứng (CHẨN_ĐOÁN), phát ban (TRIỆU_CHỨNG), nổi mề đay (TRIỆU_CHỨNG) |
| Ung thư/u | CHẨN_ĐOÁN | ung thư phổi, ung thư vú, u ác tính, khối u, di căn, K phổi |
...
def build_stage1_user_prompt(input_text: str) -> str:
    ...
    return (
        ...
        "    - `nhồi máu cơ tim`, `nhồi máu não`, `xuất huyết não` → CHẨN_ĐOÁN (bệnh lý nặng)\n"
        "    - `viêm tim`, `viêm cơ tim`, `viêm màng ngoài tim`, `viêm nội tâm mạc` → CHẨN_ĐOÁN (bệnh lý tim mạch)\n"
        "    - `phình giãn động mạch vành`, `phình động mạch`, `hẹp tắc mạch`, `huyết khối`, `thuyên tắc phổi` → CHẨN_ĐOÁN (bệnh lý mạch máu)\n"
        "    - `bệnh Kawasaki`, `bệnh Still`, `bệnh Parkinson` (named disease) → CHẨN_ĐOÁN\n"
        "    - `tay chân miệng`, `sởi`, `thủy đậu`, `ho gà`, `bạch hầu`, `rubella`, `sốt xuất huyết` → CHẨN_ĐOÁN (bệnh nhi đặc biệt)\n"
        ...
        "    - CHẨN_ĐOÁN ≥ 5 entities (nếu bệnh án >2000 chars). Đặc biệt các bệnh thường MISS: viêm tim, viêm cơ tim, viêm mạch, viêm màng não, thiếu men G6PD, phình giãn động mạch vành, huyết khối, Kawasaki.\n"
        "    - TRIỆU_CHỨNG ≥ 8 entities. Đặc biệt các triệu chứng hay MISS: sốt cao (kèm nhiệt độ), phù (chân, mặt), buồn nôn, chóng mặt, vàng da, vàng mắt.\n"
        "    - TÊN_XÉT_NGHIỆM ≥ 2 entities. Đặc biệt: công thức máu, sinh hóa, X-quang, siêu âm, ECG, MRI, CT, Holter, nội soi.\n"
        "    - THUỐC đầy đủ name + strength + route. Nếu có điều trị mà chưa extract được thuốc nào → check lại.\n"
        "    - KẾT_QUẢ_XÉT_NGHIỆM: nếu input có số liệu (120/80 mmHg, 38.5°C, 96%, HbA1c 6.5%) → extract.\n\n"
...
# 🧠 CHAIN-OF-THOUGHT (CoT) - BẮT BUỘC CHO MỖI ENTITY
...
- "G6PD deficiency" + [D55.0, Q55.0, D55, E55.0]
  ...
  - Q55.0 (testis absence) → 1 (WRONG concept - testis defect)
  - E55.0 (vitamin A deficiency) → 1 (WRONG concept - vitamin not blood)
...
| Pattern trong text | ICD code PHẢI LOẠI | Lý do |
|---|---|---|
| "thiếu máu", "thiếu máu tan huyết", "thiếu máu do tan huyết" | Q55, Q44, Q00-Q99 (congenital khác) | Đây là bệnh lý về máu, không phải dị tật bẩm sinh |
| "G6PD", "thiếu men G6PD", "Glucose-6-Phosphate Dehydrogenase" | Q55 (testis absence), M08 (juvenile arthritis), E55 (vitamin A) | Sai concept hoàn toàn |
| "viêm X" cho organ | Z00-Z99 (factors influencing health) | Đây là bệnh thực sự, không phải yếu tố |
| "ung thư X" | K00-K93 (digestive), nếu organ khác | Match ICD theo organ (vd ung thư phổi → C34) |
| "người lớn viêm khớp", "RA" | M05-M14 (rheumatoid), KHÔNG Q (juvenile) | RA người lớn không phải juvenile RA |
| "nhiễm khuẩn huyết do MRSA" | A49 (unspecified), U80 (MRSA-specific) | Chọn U80 nếu specify MRSA, A49 nếu chỉ "nhiễm khuẩn huyết" |
| "Kawasaki" trẻ em | M30.3 | Đúng concept |
| "viêm tim", "viêm cơ tim" | I40-I41 (myocarditis) | KHÔNG B33.2 (viral pericarditis không phải viêm cơ tim) |
| "phình giãn động mạch vành" | I25.4 (coronary aneurysm) | KHÔNG G07 (intracranial abscess) |
| "viêm mạch" | I77.6, M30-M31 (vasculitis) | Match vasculitis, không match viêm nhiễm khuẩn |

# 🚨 R39 — RXNORM HARD REJECTION:
| Pattern | Action |
|---|---|
| "bicarbonate", "creatinine", "urea", "sodium", "potassium" (lab context) | DROP candidate (lab value, không phải thuốc điều trị) |
| "kháng X" (resistance context, vd "kháng methicillin") | DROP candidate (mention về resistance, không phải drug treatment) |
| "kháng sinh", "NSAID", "corticoid", "kháng đông" (drug class) | DROP candidate (chỉ là class name) |
